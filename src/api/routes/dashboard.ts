...
function buildExamples() {
  ...
  -F "sample_strength=0.55"`,
      ...
      video: {
        ...
        curl: `curl -X POST https://api.nofx.online/v1/videos/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer your_sessionid" \\
  -d '{"model":"jimeng-video-3.5-pro","prompt":"海边奔跑的白色小狗，电影镜头","ratio":"16:9","resolution":"720p","duration":5}'`,
      ...
      models: {
        ...
        curl: 'curl https://api.nofx.online/v1/models',
      ...
      international_note: {
        ...
        curl: `curl -X POST https://api.nofx.online/v1/videos/international/generations \\
