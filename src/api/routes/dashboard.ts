...
function buildExamples() {
  return {
    examples: {
      image_text: {
        title: '文生图 JSON',
        group: 'image',
        description: '调用 OpenAI 兼容图片生成接口。API KEY 可随便填写；真正的鉴权由服务端 session 池自动轮换完成。',
  ...
  -d '{"model":"jimeng-video-3.5-pro","prompt":"海边奔跑的白色小狗，电影镜头","ratio":"16:9","resolution":"720p","duration":5}'`,
      ...
      international_note: {
        title: '国际版 / 异步补充',
        group: 'video',
        description: '国际版视频接口与异步查询先放在说明区，避免第一版主界面过重。API KEY 可随便填写；真正的鉴权由服务端 session 池自动轮换完成。',
